...
function BiWebService() {
    ...
    if (el.addBehavior) {
        el.addBehavior(application.getPath() + "" + BiWebService.HTC_PATH);
        document.getElementsByTagName("head")[0].appendChild(el);
        return el;
    }
    throw new Error("Not implemented. Use BiWebService2 instead");
}
_p = _biExtend(BiWebService, Object, "BiWebService");
BiWebService.HTC_PATH = "js/biwebservice.htc";
BiWebService.create = function () {
