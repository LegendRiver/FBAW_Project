...
exportAdSetRetention();

function exportAdSetRetention()
{
    ServerLogger::instance()->writeLog(Warning, 'Start to export AdSet Retention .....');
    ...
    foreach($parentIds as $parentId)
    {
        ...
        {
            AdSetInsightExportHelper::getInstance()->exportCsvFile($insightInfoPath, $parentId, $reDate, $reDate,
    ...
    ServerLogger::instance()->writeLog(Warning, 'Succeed to export AdSet Retention.');
}