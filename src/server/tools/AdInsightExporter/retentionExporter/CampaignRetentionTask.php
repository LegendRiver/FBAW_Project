...
exportCampaignRetention();

function exportCampaignRetention()
{
    ServerLogger::instance()->writeLog(Warning, 'Start to export Campaign Retention .....');
    ...
    foreach($parentIds as $parentId)
    {
        ...
        {
            CampaignExportHelper::getInstance()->exportCsvFile($insightInfoPath, $parentId, $reDate, $reDate,
    ...
    ServerLogger::instance()->writeLog(Warning, 'Succeed to export Campaign Retention.');
}