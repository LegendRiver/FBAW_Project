...
function exportProfitReport()
{
    try
    {
        ...
        $envFile = $rootPath . 'conf' . DIRECTORY_SEPARATOR . 'fake_profit_env_conf.json';
...
//        $currentDir = $rootPath . 'output';
        ...
        //export fb data
        $configFile = $rootPath. 'conf'. DIRECTORY_SEPARATOR . 'fake_conf_profit.json';
        $templateFile = $rootPath. 'template'. DIRECTORY_SEPARATOR . 'template_flexible.xlsx';
        ReportRun::exportProfitReport($configFile, $templateFile, $currentDir,
