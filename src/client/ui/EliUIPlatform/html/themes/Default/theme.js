 ...
 * license.
 */
function BiDefaultTheme(sName) {
    if (_biInPrototype) return;
    BiTheme.call(this, sName || "Default");
    var base = String(new BiUri(application.getPath(), "themes/Default/"));
    ...
    this.setAppearanceProperty("window", "default-icon", imgBase + "default.16.gif");
...
_p = _biExtend(BiDefaultTheme, BiTheme, "BiDefaultTheme");
_p._themeTypes = {};
_p._themeTypes[BiTheme.KEYS.window] = {
    sizes: {
        l: 15,
        r: 15,
        t: 100,
...
_p._themeTypes[BiTheme.KEYS.popupBackground] = {
    sizes: {
        l: 6,
        r: 6,
        t: 10,
...
_p._themeTypes[BiTheme.KEYS.toolBarButton] = _p._themeTypes[BiTheme.KEYS.button] = {
    sizes: {
        l: 4,
        r: 4,
        t: 11,
...
_p._themeTypes[BiTheme.KEYS.tabButton] = {
    sizes: {
        l: 5,
        r: 5,
        t: 11,
...
application.getThemeManager().addTheme(new BiDefaultTheme);
