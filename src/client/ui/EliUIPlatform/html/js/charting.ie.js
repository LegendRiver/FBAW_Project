...
_p._chartType = "line";
BiGraph._createVmlElement = function (sTagName) {
    var c = new BiComponent;
    c._tagName = sTagName || "v:shape";
    return c;
};
BiGraph._vmlComponent1000 = function (o) {
    o.setHtmlProperty("coordsize", "1000,1000");
    o.setHtmlProperty("coordorigin", "0,0");
    o.setLocation(0, 0);
    o.setSize(1000, 1000);
};
BiGraph._addNs = function (d) {
    if (!d) d = document;
    if (!d.namespaces["v"]) {
...
_p._updateCoordSize = function () {
    ...
    if (this._getCategoryOnXAxis()) {
        coordSize = catCoordSize * this._catScaleFactor + "," + (max - min);
        coordOrigin = "0," + min;
    } else {
        coordSize = (max - min) + "," + catCoordSize * this._catScaleFactor;
        coordOrigin = min + ",0";
    }
...
BiGraph._addExtendedFillInterface = function (p) {
    p._fillOpacity = null;
    p._fillColor2 = null;
    p._fillType = null;
    p._fillAngle = null;
    p._createFillEl = function (oParent) {
        this._fillEl = BiGraph._createVmlElement("v:fill");
        (oParent || this).add(this._fillEl);
        this.setFillOpacity(this.getFillOpacity());
        this.setFillColor2(this.getFillColor2());
        this.setFillType(this.getFillType());
        this.setFillAngle(this.getFillAngle());
    };
    p.setFillOpacity = function (n) {
        this._fillOpacity = n;
        this._fillEl.setHtmlProperty("opacity", n);
    };
    ...
    p.setFillColor2 = function (s) {
        this._fillColor2 = s;
        this._fillEl.setHtmlProperty("color2", s);
    };
    ...
    p.setFillType = function (s) {
        this._fillType = s;
        this._fillEl.setHtmlProperty("type", s);
    };
    ...
    p.setFillAngle = function (s) {
        this._fillAngle = s;
        this._fillEl.setHtmlProperty("angle", s);
    };
...
BiGraph._addExtendedStrokeInterface = function (p) {
    p._strokeOpacity = null;
    p._createStrokeEl = function (oParent) {
        this._strokeEl = BiGraph._createVmlElement("v:stroke");
        (oParent || this).add(this._strokeEl);
        this.setStrokeOpacity(this.getStrokeOpacity());
    };
    p.setStrokeOpacity = function (n) {
        this._strokeOpacity = n;
        this._strokeEl.setHtmlProperty("opacity", n);
    };
...
_p._create = function (d) {
    BiGraph._addNs(d);
    BiGraphBase.prototype._create.call(this, d);
};
...
_p = _biExtend(BiGraphContentArea, BiComponent, "BiGraphContentArea");
_p._tagName = "v:group";
...
function BiChartArea(oGraph) {
    ...
    this._backgroundRect = BiGraph._createVmlElement("v:rect");
    this._backgroundRect.setLocation(0, 0);
    this._backgroundRect.setSize(1000, 1000);
    this._backgroundRect.setHtmlProperty("stroked", false);
    this._backgroundRect.setHtmlProperty("fillcolor", "white");
    this._backgroundRect.setZIndex(0);
    this._backgroundRect.setStyleProperty("antialias", "false");
    this._outlineRect = BiGraph._createVmlElement("v:rect");
    this._outlineRect.setLocation(0, 0);
    this._outlineRect.setSize(1000, 1000);
    this._outlineRect.setHtmlProperty("filled", false);
    this._outlineRect.setHtmlProperty("strokecolor", "black");
    this._outlineRect.setZIndex(1);
    this._outlineRect.setStyleProperty("antialias", "false");
    this.add(this._backgroundRect);
    this.add(this._outlineRect);
    this._createFillEl(this._backgroundRect);
    this._createStrokeEl(this._backgroundRect);
};
_p = _biExtend(BiChartArea, BiChartAreaBase, "BiChartArea");
_p._tagName = "v:group";
_p.layoutAllChildren = function () {
    BiChartAreaBase.prototype.layoutAllChildren.call(this);
...
_p.setFillColor = function (s) {
    this._fillColor = s;
    this._backgroundRect.setHtmlProperty("filled", s != "transparent");
    this._backgroundRect.setHtmlProperty("fillcolor", s);
};
_p.setStrokeColor = function (s) {
    this._strokeColor = s;
    this._outlineRect.setHtmlProperty("stroked", s != "transparent");
    this._outlineRect.setHtmlProperty("strokecolor", s);
};
BiGraph._addExtendedFillInterface(_p);
BiGraph._addExtendedStrokeInterface(_p);
...
function BiVmlLabel(sText) {
    if (_biInPrototype) return;
    BiComponent.call(this);
    this.setHtmlProperty("coordsize", "1,1");
    this.setSize(10000, 10000);
    if (sText != null) this._text = sText;
    this.setStyleProperty("antialias", "true");
    this.setStyleProperty("fontSize", "11px");
};
_p = _biExtend(BiVmlLabel, BiComponent, "BiVmlLabel");
_p._tagName = "v:group";
_p._text = "";
_p._align = "center";
_p._flipY = true;
_p.setAlign = function (sAlign) {
    if (this._align != sAlign) {
        this._align = sAlign;
        if (this.getCreated()) {
            this._textPathEl.style["v-text-align"] = sAlign;
            var y = this._flipY ? 1 : 0;
            var x, w = 100;
            if (this._align == "left") x = 0;
            else if (this._align == "right") x = -100;
            else x = -50;
            se.path = "m" + x + "," + y + "l" + (x + w) + "," + y;
        }
    }
};
BiVmlLabel.addProperty("align", BiAccessType.READ);
_p.setText = function (sText) {
    if (this._text != sText) {
        this._text = sText;
        if (this.getCreated()) this._textPathEl.style["v-text-align"] = sAlign;
    }
};
BiVmlLabel.addProperty("text", BiAccessType.READ);
_p._create = function (oDoc) {
    BiComponent.prototype._create.call(this, oDoc);
    var se = this._shapeEl = this._document.createElement("v:shape");
    var pe = this._pathEl = this._document.createElement("v:path");
    var tp = this._textPathEl = this._document.createElement("v:textpath");
    se.stroked = false;
    se.style.width = "100%";
    se.style.height = "100%";
    se.fillcolor = "black";
    if (this._flipY) se.style.flip = "y";
    var y = this._flipY ? 1 : 0;
    var x, w = 100;
    if (this._align == "left") x = 0;
    else if (this._align == "right") x = -100;
    ...
    pe.textpathok = true;
    tp.on = true;
    tp.string = this._text;
    tp.style["v-text-align"] = this._align;
    se.appendChild(pe);
    se.appendChild(tp);
    this._element.appendChild(se);
};
_p._dispose = function () {
    if (this._disposed) return;
    BiComponent.prototype.dispose.call(this);
    if (this._shapeEl) this._shapeEl.outerHTML = "";
    this._shapeEl = null;
    if (this._pathEl) this._pathEl.outerHTML = "";
    this._pathEl = null;
    if (this._textPathEl) this._textPathEl.outerHTML = "";
    this._textPathEl = null;
};
_p.setFontSize = function (n) {
    this.setStyleProperty("fontSize", n + "px");
    if (this._created) this._textPathEl.style.fontSize = n + "px";
};

function BiChartValueAxis(oGraph) {
    if (_biInPrototype) return;
    BiChartValueAxisBase.call(this, oGraph);
    this._majorTicks = BiGraph._createVmlElement();
    this._minorTicks = BiGraph._createVmlElement();
    this._axisLine = BiGraph._createVmlElement();
...
_p = _biExtend(BiChartValueAxis, BiChartValueAxisBase, "BiChartValueAxis");
_p._tagName = "v:group";
_p._showMajorTicks = true;
_p._showMinorTicks = true;
_p._updateCoordSize = function (sCoordSize, sCoordOrigin) {
    ...
    this.setHtmlProperty("coordsize", sCoordSize);
    this._majorTicks.setHtmlProperty("coordsize", sCoordSize);
    this._minorTicks.setHtmlProperty("coordsize", sCoordSize);
    this._axisLine.setHtmlProperty("coordsize", sCoordSize);
    this.setHtmlProperty("coordorigin", sCoordOrigin);
    this._majorTicks.setHtmlProperty("coordorigin", sCoordOrigin);
    this._minorTicks.setHtmlProperty("coordorigin", sCoordOrigin);
    this._axisLine.setHtmlProperty("coordorigin", sCoordOrigin);
    this._majorTicks.setLocation(x, y);
    this._majorTicks.setSize(w, h);
    this._minorTicks.setLocation(x, y);
    this._minorTicks.setSize(w, h);
    this._axisLine.setLocation(x, y);
    this._axisLine.setSize(w, h);
    var s = this._graph.getSeries();
    var c;
...
_p._updateAxisLine = function () {
    ...
    if (onX) this._axisLine.setHtmlProperty("path", "m " + x0 + "," + min + " l " + x0 + "," + max);
    else this._axisLine.setHtmlProperty("path", "m " + min + "," + x0 + " l " + max + "," + x0);
};
_p._updateMajorTicks = function () {
    if (this._showMajorTicks) {
        ...
        while (y <= max) {
            ...
            if (onX) sb.push("m ", x0, ",", y2, " l ", x1, ",", y2);
            else sb.push("m ", y2, ",", x0, " l ", y2, ",", x1);
            y += major;
            y = Math.round(y / major) * major;
        }
        sb.push("e");
        this._majorTicks.setHtmlProperty("path", sb.join(BiString.EMPTY));
    }
};
_p._updateMinorTicks = function () {
    if (this._showMinorTicks) {
        ...
        sb.push("e");
        this._minorTicks.setHtmlProperty("path", sb.join(BiString.EMPTY));
    }
};
_p._updateLabels = function () {
    ...
    if (this._showLabels) {
        ...
        while (y <= max) {
            ...
            l = new BiVmlLabel(ys);
            l.setFontSize(this._fontSize);
            if (onX) {
                l.setAlign("right");
                l.setLocation(-1000, y2);
            } else {
                l.setAlign("center");
                l.setLocation(y2, -2 * 1000);
            }
            this.add(l);
            this._labels.push(l);
            y += major;
...
_p = _biExtend(BiChartCategoryAxis, BiChartCategoryAxisBase, "BiChartCategoryAxis");
_p._tagName = "v:group";
_p._updateCoordSize = function (sCoordSize, sCoordOrigin) {
    var p = sCoordSize.split(",");
    var w = Number(p[0]),
...
_p._updateAxisLine = function () {
    ...
    var min = 0;
    var onX = this._graph._getCategoryOnXAxis();
    if (onX) this._axisLine.setHtmlProperty("path", "m " + min + "," + y0 + " l " + max + "," + y0);
    else this._axisLine.setHtmlProperty("path", "m " + y0 + "," + min + " l " + y0 + "," + max);
};
_p._updateMajorTicks = function () {
    if (this._showMajorTicks) {
        var y0 = 0;
        ...
        while (x <= catMax) {
            ...
            if (onX) sb.push("m ", x2, ",", y0, " l ", x2, ",", y1);
            else sb.push("m ", y0, ",", x2, " l ", y1, ",", x2);
            x += major;
...
_p._updateLabels = function () {
    ...
    if (this._showLabels) {
        ...
        while (x <= catMax) {
            x2 = Math.round(x * this._graph._catScaleFactor);
            l = new BiVmlLabel(cats[Math.floor(x)].getTitle());
            l.setFontSize(this._fontSize);
            if (onX) {
                l.setLocation(x2, -.04 * this._coordSize);
                l.setAlign("center");
            } else {
                l.setLocation(-.02 * this._coordSize, x2);
                l.setAlign("right");
            }
            this.add(l);
            this._labels.push(l);
...
function BiChartGridLines(oGraph) {
    ...
    this.setStyleProperty("antialias", "false");
    BiGraph._vmlComponent1000(this);
    this._minorCategory = BiGraph._createVmlElement();
    ...
    BiGraph._vmlComponent1000(this._minorCategory);
    BiGraph._vmlComponent1000(this._minorValue);
    BiGraph._vmlComponent1000(this._majorCategory);
    BiGraph._vmlComponent1000(this._majorValue);
    ...
    this._minorCategory.setHtmlProperty("strokecolor", this.getMinorCategoryStrokeColor());
    this._minorValue.setHtmlProperty("strokecolor", this.getMajorCategoryStrokeColor());
    this._majorCategory.setHtmlProperty("strokecolor", this.getMinorValueStrokeColor());
    this._majorValue.setHtmlProperty("strokecolor", this.getMajorValueStrokeColor());
    this.add(this._minorCategory);
    this.add(this._minorValue);
    this.add(this._majorCategory);
    this.add(this._majorValue);
};
_p = _biExtend(BiChartGridLines, BiChartGridLinesBase, "BiChartGridLines");
_p._tagName = "v:group";
_p.setShowMinorValue = function (b) {
    BiChartGridLinesBase.prototype.setShowMinorValue.call(this, b);
    this._minorValue.setVisible(b);
};
_p.setShowMajorValue = function (b) {
    BiChartGridLinesBase.prototype.setShowMajorValue.call(this, b);
    this._majorValue.setVisible(b);
};
_p.setShowMinorCategory = function (b) {
    BiChartGridLinesBase.prototype.setShowMinorCategory.call(this, b);
    this._minorCategory.setVisible(b);
};
_p.setShowMajorCategory = function (b) {
    BiChartGridLinesBase.prototype.setShowMajorCategory.call(this, b);
    this._majorCategory.setVisible(b);
};
_p.setMinorCategoryStrokeColor = function (s) {
    this._minorCategoryStrokeColor = s;
    this._minorCategory.setHtmlProperty("stroked", s != "transparent");
    this._minorCategory.setHtmlProperty("strokecolor", s);
};
_p.setMajorCategoryStrokeColor = function (s) {
    this._majorCategoryStrokeColor = s;
    this._majorCategory.setHtmlProperty("stroked", s != "transparent");
    this._majorCategory.setHtmlProperty("strokecolor", s);
};
_p.setMinorValueStrokeColor = function (s) {
    this._minorValueStrokeColor = s;
    this._minorValue.setHtmlProperty("stroked", s != "transparent");
    this._minorValue.setHtmlProperty("strokecolor", s);
};
_p.setMajorValueStrokeColor = function (s) {
    this._majorValueStrokeColor = s;
    this._majorValue.setHtmlProperty("stroked", s != "transparent");
    this._majorValue.setHtmlProperty("strokecolor", s);
};
_p.dispose = function () {
    if (this._disposed) return;
...
_p._updateCoordSize = function (sCoordSize, sCoordOrigin) {
    this._minorCategory.setHtmlProperty("coordsize", sCoordSize);
    this._minorValue.setHtmlProperty("coordsize", sCoordSize);
    this._majorCategory.setHtmlProperty("coordsize", sCoordSize);
    this._majorValue.setHtmlProperty("coordsize", sCoordSize);
    this._minorCategory.setHtmlProperty("coordorigin", sCoordOrigin);
    this._minorValue.setHtmlProperty("coordorigin", sCoordOrigin);
    this._majorCategory.setHtmlProperty("coordorigin", sCoordOrigin);
    this._majorValue.setHtmlProperty("coordorigin", sCoordOrigin);
    this._updateMajorValue();
    this._updateMinorValue();
    this._updateMajorCategory();
    this._updateMinorCategory();
...
_p._updateMajorValue = function () {
    if (this.getShowMajorValue()) {
        ...
        sb.push("e");
        this._majorValue.setHtmlProperty("path", sb.join(BiString.EMPTY));
    }
};
_p._updateMinorValue = function () {
    if (this.getShowMinorValue()) {
        ...
        sb.push("e");
        this._minorValue.setHtmlProperty("path", sb.join(BiString.EMPTY));
    }
};
_p._updateMajorCategory = function () {
    if (this.getShowMajorCategory()) {
        ...
        sb.push("e");
        this._majorCategory.setHtmlProperty("path", sb.join(BiString.EMPTY));
    }
};
_p._updateMinorCategory = function () {
    if (this.getShowMinorCategory()) {
        ...
        sb.push("e");
        this._minorCategory.setHtmlProperty("path", sb.join(BiString.EMPTY));
    }
};
_p.setVisible = function (b) {
    this._desiredVisible = b;
...
_p = _biExtend(BiAbstractChart, BiAbstractChartBase, "BiAbstractChart");

function BiAbstractChartSection(oChart, oCategory) {
    if (_biInPrototype) return;
    if (!oChart) return;
    BiAbstractChartSectionBase.call(this, oChart, oCategory);
    this.setHtmlProperty("fillcolor", this.getFillColor());
    this.setHtmlProperty("strokecolor", this.getStrokeColor());
    this._createFillEl();
    this._createStrokeEl();
};
_p = _biExtend(BiAbstractChartSection, BiAbstractChartSectionBase, "BiAbstractChartSection");
BiGraph._addExtendedFillInterface(_p);
BiGraph._addExtendedStrokeInterface(_p);
_p.getStrokeOpacity = function () {
    return this._graph.getPresentationManager().getStrokeOpacity(this._seriesId, this._categoryId);
...
function BiLineChart(oGraph, oSeries) {
    ...
    this._pathComponent = new BiComponent;
    this._pathComponent._tagName = "v:shape";
    this._pathComponent.setHtmlProperty("strokecolor", this.getStrokeColor());
    this._pathComponent.setHtmlProperty("strokeweight", this.getStrokeWidth());
    this._pathComponent.setHtmlProperty("filled", "false");
    this.add(this._pathComponent);
    this._markersByCat = {};
    this._createShapeType();
    this._createStrokeEl(this._pathComponent);
    this.setStrokeOpacity(this.getStrokeOpacity());
    this.add(this._lineMarker);
};
...
_p._setPath = function () {
    ...
    var l = vs.length;
    for (var i = 0; i < l; i++) {
        if (vs[i - 1] != null && vs[i] != null) sb.push("m", ((i - 1 + dx) * this._graph._catScaleFactor), ",", Math.round(vs[i - 1] * this._graph._scaleFactor), "l", ((i + dx) * this._graph._catScaleFactor), ",", Math.round(vs[i] * this._graph._scaleFactor));
    }
    sb.push("e");
    this._pathComponent.setHtmlProperty("path", sb.join(""));
};
_p.getComponentByCategoryId = function (sCatId) {
    ...
    if (this._showMarkers) {
        ...
        for (i = 0; i < l; i++) {
            ...
            if (vs[i] != null && pm.getMarkerVisible(sId, cId)) {
                m = new BiLineMarker(this, cats[i]);
                m.setSize(this._coordSizeW / 50, this._coordSizeH / 50);
                m.setLocation((i + dx) * this._graph._catScaleFactor, Math.round(vs[i] * this._graph._scaleFactor));
                this.add(m);
...
_p._updateMarkerByCategoryId = function (sId) {
    ...
    if (m) m.setTop(this._series.getValueByCategoryId(sId) * this._graph._scaleFactor);
};
_p._updateCoordSize = function (sCoordSize, sCoordOrigin) {
    var p = sCoordSize.split(",");
    var w = Number(p[0]),
    ...
    this._pathComponent.setSize(w, h);
    this._pathComponent.setHtmlProperty("coordsize", sCoordSize);
    this._pathComponent.setHtmlProperty("coordorigin", sCoordOrigin);
    this._coordSizeW = w;
    this._coordSizeH = h;
    this._createMarkers();
};
...
_p._createShapeType = function () {
    var c = new BiComponent;
    c._tagName = "v:shapetype";
    c.setHtmlProperty("stroked", true);
    c.setHtmlProperty("filled", true);
    this._lineMarkerId = c.getHtmlProperty("id");
    switch (this.getMarkerType()) {
    case "square":
        c.setHtmlProperty("coordsize", "1000,1000");
        c.setHtmlProperty("path", "m -400,-400 l 400,-400 400,400 -400,400 xe");
        break;
    case "circle":
        c.setHtmlProperty("coordsize", "1000,1000");
        c.setHtmlProperty("path", "at -500,-500 500,500 0,-500 0,-500 xe");
        break;
    case "triangle":
        c.setHtmlProperty("coordsize", "1000,1000");
        c.setHtmlProperty("path", "m -500,-289 l 0,577 500,-289 xe");
        break;
    case "diamond":
    default:
        c.setHtmlProperty("coordsize", "1000,1000");
        c.setHtmlProperty("path", "m -520,0 l 0,-520 520,0 0,520 xe");
        break;
    };
    this._lineMarker = c;
};
...
function BiLineMarker(oChart, oCategory) {
    if (_biInPrototype) return;
    BiAbstractChartSection.call(this, oChart, oCategory);
    BiGraph._vmlComponent1000(this);
    this.setHtmlProperty("type", "#" + oChart._lineMarkerId);
};
_p = _biExtend(BiLineMarker, BiAbstractChartSection, "BiLineMarker");
_p._tagName = "v:shape";
...
function BiColumnChart(oGraph, oSeries) {
    ...
    this._rectsByCat = {};
    BiGraph._vmlComponent1000(this);
    this.setStyleProperty("width", "1000px");
    this.setStyleProperty("height", "1000px");
    this.setStyleProperty("antialias", "false");
};
...
_p._updateChart = function () {
    ...
    for (i = 0; i < l; i++) {
        if (vs[i] != null) {
            ...
            if (this._isBar) {
                rect.setLocation(this._graph._scaleFactor * this._getRectTop(id), this._graph._catScaleFactor * (i + dx));
                rect.setSize(this._graph._scaleFactor * this._getRectHeight(id), this._graph._catScaleFactor * w);
            } else {
                rect.setLocation(this._graph._catScaleFactor * (i + dx), this._graph._scaleFactor * this._getRectTop(id));
                rect.setSize(this._graph._catScaleFactor * w, this._graph._scaleFactor * this._getRectHeight(id));
            }
            this.add(rect);
...
_p._updateRectByCategoryId = function (sId) {
    ...
    else rect.setHeight(this._getRectHeight(sId) * this._graph._scaleFactor); if (this._isStacked) {
        if (this._isBar) rect.setLeft(this._getRectTop(sId) * this._graph._scaleFactor);
        else rect.setTop(this._getRectTop(sId) * this._graph._scaleFactor);
    } else {
...
function BiPieChart(oGraph, oSeries) {
    ...
    this.setStyleProperty("height", "1000px");
    this.setHtmlProperty("coordsize", "1000,1000");
    this.setHtmlProperty("coordorigin", "-500,-500");
...
_p._updateAspectRatio = function (e) {
    var cw = this._graph._chartArea.getWidth();
    var ch = this._graph._chartArea.getHeight();
    var coordSize, coordOrigin;
    if (cw > ch) {
    ...
    this.setHtmlProperty("coordsize", coordSize);
    this.setHtmlProperty("coordorigin", coordOrigin);
};
_p._updateCoordSize = function (sCoordSize, sCoordOrigin) {};
_p.update = function () {
    this._updateChart();
...
_p._updateAllSections = function () {
    var sum = 0;
    var i, values = this._series.getValues();
...
_p._setPath = function () {
    ...
    if (this._startAngle == this._endAngle) {
        ...
        var left = Math.round(startX - r);
        var top = Math.round(startY - r);
        var right = Math.round(left + w);
        var bottom = Math.round(top + w);
        sPath = "m" + startX + "," + startY + "at" + left + "," + top + "," + right + "," + bottom + "," + startRadX + "," + startRadY + "," + endRadX + "," + endRadY + "xe";
    }
