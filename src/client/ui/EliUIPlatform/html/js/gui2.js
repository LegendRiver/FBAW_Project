...
function BiGauge() {
    ...
    var gi = this._gaugeInside = new BiGaugeInside;
    var title = gi._title = new BiGaugeTitle(gi);
    BiComponent.prototype.add.call(this, title);
    BiComponent.prototype.add.call(this, gi);
}
_p = _biExtend(BiGauge, BiComponent, "BiGauge");
_p.add = function (oChild) {
    this._gaugeInside.add(oChild);
};
_p.setPlate = function (oPlate) {
    this._gaugeInside.setPlate(oPlate);
};
_p.setMinorTicks = function (oTicks) {
    this._gaugeInside.setMinorTicks(oTicks);
};
_p.setMajorTicks = function (oTicks) {
    this._gaugeInside.setMajorTicks(oTicks);
};
_p.setNeedle = function (oNeedle) {
    this._gaugeInside.setNeedle(oNeedle);
};
_p.setWarningSection = function (oSection) {
    this._gaugeInside.setWarningSection(oSection);
};
_p.setTitle = function (oTitle) {
    this._gaugeInside.setTitle(oTitle);
};
_p.getTitle = function () {
    return this._gaugeInside.getTitle();
};
_p.setLabels = function (oLabels) {
    this._gaugeInside.setLabels(oLabels);
};
_p.setValue = function (nValue) {
    this._gaugeInside.setValue(nValue);
};
_p.getValue = function () {
    return this._gaugeInside.getValue();
};
_p.setMaximum = function (nMaximum) {
    this._gaugeInside.setMaximum(nMaximum);
};
_p.getMaximum = function () {
    return this._gaugeInside.getMaximum();
};
_p.setMinimum = function (nMinimum) {
    this._gaugeInside.setMinimum(nMinimum);
};
_p.getMinimum = function () {
    return this._gaugeInside.getMinimum();
};
_p.setWarningValue = function (n) {
    this._gaugeInside.setWarningValue(n);
};
_p.setShowLabels = function (b) {
    this._gaugeInside.setShowLabels(b);
};
_p.setShowTitle = function (b) {
    this._gaugeInside.setShowTitle(b);
};
_p.setShowMajorTicks = function (b) {
    this._gaugeInside.setShowMajorTicks(b);
};
_p.setShowMinorTicks = function (b) {
    this._gaugeInside.setShowMinorTicks(b);
};
_p.setShowWarningSection = function (b) {
    this._gaugeInside.setShowWarningSection(b);
};
_p.setLabelInterval = function (n) {
    this._gaugeInside.setLabelInterval(n);
};
_p.setMajorTickInterval = function (n) {
    this._gaugeInside.setMajorTickInterval(n);
};
_p.setMinorTickInterval = function (n) {
    this._gaugeInside.setMinorTickInterval(n);
};
_p.setMinimumAngle = function (n) {
    this._gaugeInside.setMinimumAngle(n);
};
_p.setMaximumAngle = function (n) {
    this._gaugeInside.setMaximumAngle(n);
};
_p.layoutAllChildren = function () {
    this._gaugeInside.setSize(this.getClientWidth(), this.getClientHeight());
    this._gaugeInside.layoutAllChildren();
    BiComponent.prototype.layoutAllChildren.call(this);
};

function BiGaugeInside() {
    if (_biInPrototype) return;
...
_p = _biExtend(BiGaugeInside, BiSvgComponent, "BiGaugeInside");
...
_p.add = function (oChild, oBefore) {
    BiSvgComponent.prototype.add.call(this, oChild, oBefore);
...
_p.remove = function (oChild) {
    BiSvgComponent.prototype.remove.call(this, oChild);
    if (oChild instanceof BiGaugeSection) this._sections.remove(oChild);
    return oChild;
};
BiGaugeInside.addProperty("sections", BiAccessType.READ);
BiGaugeInside.addProperty("plate", BiAccessType.READ);
BiGaugeInside.addProperty("minorTicks", BiAccessType.READ);
BiGaugeInside.addProperty("majorTicks", BiAccessType.READ);
BiGaugeInside.addProperty("needle", BiAccessType.READ);
BiGaugeInside.addProperty("title", BiAccessType.READ);
BiGaugeInside.addProperty("labels", BiAccessType.READ);
_p.setPlate = function (oPlate) {
...
BiGaugeInside.addProperty("warningValue", BiAccessType.READ);
_p.setShowLabels = function (b) {
...
BiGaugeInside.addProperty("showLabels", BiAccessType.READ);
_p.setShowTitle = function (b) {
    this._showTitle = b;
    this._title.setVisible(b);
};
BiGaugeInside.addProperty("showTitle", BiAccessType.READ);
_p.setShowMajorTicks = function (b) {
    this._showMajorTicks = b;
    this._majorTicks.setVisible(b);
};
BiGaugeInside.addProperty("showMajorTicks", BiAccessType.READ);
_p.setShowMinorTicks = function (b) {
...
BiGaugeInside.addProperty("showMinorTicks", BiAccessType.READ);
_p.setShowWarningSection = function (b) {
...
BiGaugeInside.addProperty("showWarningSection", BiAccessType.READ);
_p.setLabelInterval = function (n) {
...
BiGaugeInside.addProperty("labelInterval", BiAccessType.READ);
_p.setMajorTickInterval = function (n) {
...
BiGaugeInside.addProperty("majorTickInterval", BiAccessType.READ);
_p.setMinorTickInterval = function (n) {
...
BiGaugeInside.addProperty("minorTickInterval", BiAccessType.READ);
_p.setMinimumAngle = function (n) {
...
BiGaugeInside.addProperty("minimumAngle", BiAccessType.READ);
_p.setMaximumAngle = function (n) {
...
BiGaugeInside.addProperty("maximumAngle", BiAccessType.READ);
...
_p.dispose = function () {
    ...
    BiSvgComponent.prototype.dispose.call(this);
    this._sections = null;
    this._plate = null;
    this._needle = null;
...
function BiGaugeSection(oGauge, nStart, nEnd) {
    ...
    BiSvgComponent.call(this);
    this._gauge = oGauge;
    if (oGauge instanceof BiGauge) this._gauge = oGauge._gaugeInside;
    this.setZIndex(0);
    this._r = 425;
    this.setColor("red");
    this.setStartValue(typeof nStart == "number" ? nStart : 90);
    this.setEndValue(typeof nEnd == "number" ? nEnd : 100);
    this.setHtmlProperty("fill", "none");
}
_p = _biExtend(BiGaugeSection, BiSvgComponent, "BiGaugeSection");
_p._tagName = "path";
_p._startValue = 90;
_p._startPoint = "M0,0";
_p._endValue = 100;
...
_p._setD = function () {
    var d = "M" + this._startPoint + " A" + this._r + "," + this._r + " 0 0 1 " + this._endPoint;
    this.setHtmlProperty("d", d);
};
_p.setStartValue = function (n) {
    this._startValue = n;
    var g = this.getGauge();
    n = Math.min(g.getMaximum(), Math.max(g.getMinimum(), n));
    var angle = g._valueToAngle(n) / 180 * Math.PI;
    this._startPoint = Math.abs(500 + (Math.sin(angle) * this._r)) + "," + Math.abs(500 - (Math.cos(angle) * this._r));
    this._setD();
};
_p.setEndValue = function (n) {
    ...
    n = Math.min(g.getMaximum(), Math.max(g.getMinimum(), n));
    var angle = g._valueToAngle(n) / 180 * Math.PI;
    this._endPoint = Math.abs(500 + (Math.sin(angle) * this._r)) + "," + Math.abs(500 - (Math.cos(angle) * this._r));
    this._setD();
};
...
_p._resizeNonScalable = function () {
    ...
    this.setHtmlProperty("stroke-width", 30);
};
...
function BiGaugePlate(oGauge) {
    ...
    this._gauge = oGauge;
    this.setZIndex(0);
    this.setHtmlProperty("rx", 994 / 2);
    this.setHtmlProperty("ry", 994 / 2);
    this.setHtmlProperty("cx", 994 / 2 + 3);
    this.setHtmlProperty("cy", 994 / 2 + 3);
    this.setStrokeColor("black");
    this.setFillColor("white");
};
_p = _biExtend(BiGaugePlate, BiSvgComponent, "BiGaugePlate");
_p._tagName = "ellipse";
...
_p._resizeNonScalable = function () {
    if (!this.getCreated()) return;
    this.setHtmlProperty("stroke-width", 8);
};
...
function BiGaugeNeedle(oGauge) {
    ...
    this.setZIndex(3);
    this._needle = new BiSvgComponent;
    this._needle._tagName = "polyline";
    this.add(this._needle);
    this._knob = new BiSvgComponent;
    this._knob._tagName = "ellipse";
    this._knob.setHtmlProperty("cx", 500);
    this._knob.setHtmlProperty("cy", 500);
    this._knob.setHtmlProperty("rx", 40);
    this._knob.setHtmlProperty("ry", 40);
    this.add(this._knob);
    this.setStrokeColor("windowtext");
    this.setFillColor("windowtext");
    this.setValue(0);
};
_p = _biExtend(BiGaugeNeedle, BiSvgComponent, "BiGaugeNeedle");
_p._value = 0;
...
function BiGaugeMinorTicks(oGauge) {
    ...
    this._gauge = oGauge;
    this.setZIndex(1);
    this.setHtmlProperty("stroke-width", 1);
    this.setHtmlProperty("stroke", "black");
    this.setVisible(oGauge.getShowMinorTicks());
    this.setLocation(0, 0);
    this.setSize(1000, 1000);
    this._update();
};
_p = _biExtend(BiGaugeMinorTicks, BiSvgComponent, "BiGaugeMinorTicks");
_p._tagName = "path";
...
_p._update = function () {
    ...
    this.setHtmlProperty("d", sb.join(""));
};
_p.layoutComponent = function () {
    BiSvgComponent.prototype.layoutComponent.call(this);
    this._resizeNonScalable();
...
_p = _biExtend(BiGaugeMajorTicks, BiSvgComponent, "BiGaugeMajorTicks");
_p._tagName = "path";
...
_p._update = function () {
    ...
    sb.push(g._getTickPath(max, 440, 410));
    this.setHtmlProperty("d", sb.join(""));
};
_p.layoutComponent = function () {
    BiSvgComponent.prototype.layoutComponent.call(this);
...
_p._resizeNonScalable = function () {
    if (!this.getCreated()) return;
    this.setHtmlProperty("stroke-width", 9);
};
...
_p = _biExtend(BiGaugeLabels, BiSvgComponent, "BiGaugeLabels");
...
_p._resizeNonScalable = function () {
    if (!this.getCreated()) return;
    for (var i = 0; i < this._labels.length; i++) this._labels[i].setAttribute("font-size", 40);
};
...
_p._createLabel = function (nValue) {
    ...
    var vr = v / 180 * Math.PI;
    var r = 360;
    var el = this._document.createElementNS("http://www.w3.org/2000/svg", "text");
    var textNode = this._document.createTextNode(nValue);
    var x = r * Math.sin(vr);
    var y = r * Math.cos(vr);
    x = 500 + x;
    y = 500 - y;
...
_p._create = function (d) {
    BiSvgComponent.prototype._create.call(this, d);
    this._createLabels();
};
_p.dispose = function () {
    if (this._disposed) return;
...
function BiWindow(sCaption) {
    ...
    this._minimizeButton = new BiLabel();
    ...
    this._maximizeButton = new BiLabel();
...
_p._fixedLayout = function () {
    this._windowCaption.setLocation(0, 0);
    this._windowCaption.setRight(0);
    this._windowCaption.setHeight(28);
    this._windowIcon.setLocation(2, 1);
    this._minimizeButton.setSize(18, 18);
    this._maximizeButton.setSize(18, 18);
    this._closeButton.setSize(18, 18);
