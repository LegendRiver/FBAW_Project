...
_p._calculatePoints = function () {
    ...
    var pointsValue1 = p1x + "," + Math.round(p1y) + " " + (p1x + needleWidth) + "," + Math.round(p1y) + " " + (p1x + needleWidth) + "," + BiGauge2ThermometerNeedle.startValue + " " + p1x + "," + BiGauge2ThermometerNeedle.startValue + " " + p1x + "," + Math.round(p1y);
    var pointsValue = p3x + "," + p3y + " " + p1x + "," + p1y + " " + p2x + "," + p2y + " " + p3x + "," + p3y;
    this.setHtmlProperty("points", pointsValue1);
};
BiGauge2ThermometerNeedle.addProperty("value", BiAccessType.READ);
_p.layoutComponent = function () {
    if (this._value == null) {
        var p = this._parent;
        this.setValue((p.getEndValue() - p.getStartValue()) / 2 + p.getStartValue());
...
_p.layoutComponent = function () {
    var needleWidth = 50;
    var pointsValue1 = this._centerX + "," + (this._top + this._height) + " " + (this._centerX + this._width) + "," + (this._top + this._height) + " " + (this._centerX + this._width) + "," + this._top + " " + this._centerX + "," + this._top + " " + this._centerX + "," + (this._top + this._height);
    this.setHtmlProperty("points", pointsValue1);
    this.setHtmlProperty("stroke", this._stroke);
    this.setHtmlProperty("strokeWidth", this._strokeWidth);
...
_p.setFont = function (o) {
    ...
    if (o instanceof BiFont) {
        ...
        else this.setStyleProperty("font-weight", "normal"); if (!o.getSize) o.setSize(50);
